...
func TestInstallSourceSupportsOnlyRestorableSources(t *testing.T) {
	for _, tc := range []struct {
		...
		{"Git SCP with bracketed host and port", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:22]:repo.git"}, "[example.com:22]:repo.git", true},
		{"Git SCP with bracketed host and empty port", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:]:repo.git"}, "", false},
		{"Git SCP with bracketed host and port zero", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:0]:repo.git"}, "", false},
		{"Git SCP with bracketed host and out-of-range port", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:65536]:repo.git"}, "", false},
		{"Git SCP with bracketed host and named port", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:ssh]:repo.git"}, "", false},
		{"Git SCP with bracketed reserved provider host and port", Entry{Source: "repo", SourceType: "git", SourceURL: "[github.com:22]:org/repo.git"}, "", false},
		{"Git SCP with malformed bracketed IPv6 host", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:22:33]:repo.git"}, "", false},
		{"Git SCP with unclosed bracketed host and port", Entry{Source: "repo", SourceType: "git", SourceURL: "[example.com:22:repo.git"}, "", false},
		...
		{"Git SCP without path after bracketed IPv6 host", Entry{Source: "repo", SourceType: "git", SourceURL: "[::1]"}, "", false},
		{"Git SCP with bracketed IPv6 host suffix", Entry{Source: "repo", SourceType: "git", SourceURL: "[::1]suffix:repo.git"}, "", false},
